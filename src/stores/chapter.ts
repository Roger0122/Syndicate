  ...
  const chapters = [
      ...
      tasks: [
        {
          id: 1,
          area: '靜謐陵墓',
          content: '完成試煉⑧ → 拿馬雷葛羅的地圖',
          completed: false,
          Ascendancy: true,
        },
        { id: 2, area: '罪孽之殿', content: '放入地圖進書房 → 殺馬雷葛羅拿毒液', completed: false },
        { id: 3, area: '罪孽之殿第二層', content: '完成試煉⑨', completed: false, Ascendancy: true },
...

    {
      ...
      tasks: [
        ...
        { id: 6, area: '大浴場', content: '完成試煉⑩ (工藝)', completed: false, Ascendancy: true },
